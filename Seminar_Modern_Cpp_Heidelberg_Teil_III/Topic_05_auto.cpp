...
namespace Auto_Examples {
    ...
    static auto sum4(int f1, short f2)
    {
        return f1 + f2;
    }

    //static auto tueWas(bool flag, float f1, double f2) -> double
    //{
    //    if (flag) {
    //        return f2;
    //    }
    ...
    //static auto tueWas(bool flag, T f1, U f2) -> decltype (f1+f2)
    //{
    //    if (flag) {
    //        return f2;
    //    }
    ...
    {
        auto result = tueWas(false, 123ll, 123l);
