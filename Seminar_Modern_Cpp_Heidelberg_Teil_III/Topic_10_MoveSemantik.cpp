...
namespace MoveSemantics {
    ...
    public:
        ...
        // copy semantics
        BigData(const BigData&);       //  Rule-of-3            // copy c'tor
        BigData& operator= (const BigData&);   //  Rule-of-3    // copy assignment

        // move semantics
        BigData(BigData&&) noexcept ;    //  Rule-of-5           // move c'tor
        BigData& operator= (BigData&&) ;   //  Rule-of-5 // move assignment
