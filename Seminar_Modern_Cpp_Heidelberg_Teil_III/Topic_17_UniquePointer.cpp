...
namespace UniquePointerGeneral {
    ...
    static std::unique_ptr<int> loadUniquePointer()
    {
        ...
        // return std::move(ptr);  // Good or bad ????
                                   // Don't do it !!!!
                                   // Kontra Produktiv
    }
...
namespace UniquePointerWrappingResourceHandles {
    ...
    static void test_05()
    {
        ...
        //const char* fileName{ "..\\..\\GeneralSnippets\\UniquePtr\\UniquePtr.cpp" };
        const char* fileName{ "C:\\Development\\Seminar_Modern_Cpp_Heidelberg_Teil_III\\Seminar_Modern_Cpp_Heidelberg_Teil_III\\Topic_17_UniquePointer.cpp" };
...
namespace UniquePointerWrappingWin32Handles {
    ...
    static void test_06()
    {
        const auto* fileName{ L"C:\\Development\\Seminar_Modern_Cpp_Heidelberg_Teil_III\\Seminar_Modern_Cpp_Heidelberg_Teil_III\\Topic_17_UniquePointer.cpp" };
